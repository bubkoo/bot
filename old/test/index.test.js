...
var issues_opened_json_1 = __importDefault(
  require("./fixtures/issues.opened.json")
);
...
describe("My Probot app", function () {
  ...
  test("creates a comment when an issue is opened", function (done) {
        ...
        switch (_a.label) {
          case 0:
            ...
            return [
              ...
              probot.receive({
                name: "issues",
                payload: issues_opened_json_1.default,
              }),
            ];
          case 1:
            // Receive a webhook event
