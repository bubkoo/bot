...
(function (Config) {
    Config.defaults = {
        checker: {
            ...
            defaultComment: 'The maintainers of this repository would appreciate it if you could provide more information.',
        },
    };
    ...
    function get(context) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, util_1.getConfig(context, Config.defaults).then(function (ret) { return ret.checker || Config.defaults.checker; })];
            });
        });
    }
    Config.get = get;
